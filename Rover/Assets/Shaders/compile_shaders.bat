...
"%VULKAN_SDK%/bin/glslc.exe" screen_space_ui_shader.vert -o screen_space_ui_shader.vert.spv
"%VULKAN_SDK%/bin/glslc.exe" screen_space_ui_shader.frag -o screen_space_ui_shader.frag.spv
